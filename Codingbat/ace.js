...
ace.define("ace/lib/dom", ["require", "exports", "module"], function(e, t, n) {
    ...
    t.importCssString = function(n, r, i) {
        i = i || document;
        if (r && t.hasCssString(r, i))
            return null;
        var s;
        r && (n += "\n/*# sourceURL=ace/css/" + r + " */"),
        i.createStyleSheet ? (s = i.createStyleSheet(),
        s.cssText = n,
        r && (s.owningElement.id = r)) : (s = t.createElement("style"),
    ...
    t.addCommandKeyListener = function(e, n) {
        ...
        if (i.isOldGecko || i.isOpera && !("KeyboardEvent"in window)) {
            ...
            r(e, "keydown", function(e) {
                var t = e.keyCode;
                s[t] = (s[t] || 0) + 1,
                t == 91 || t == 92 ? s.OSKey = !0 : s.OSKey && e.timeStamp - s.lastT > 200 && s.count == 1 && f(),
                s[t] == 1 && s.count++,
                s.lastT = e.timeStamp;
                var r = a(n, e, t);
      ...
      , f = function(e, t) {
        ...
        var L = !1
          , A = function(e) {
            ...
            c ? (b(),
            e && t.onPaste(e),
            c = !1) : e == f.charAt(0) ? L ? t.execCommand("del", {
                source: "ace"
          ...
          , _ = function(e, i) {
            ...
            M(e, s) ? (i ? t.onCut() : t.onCopy(),
            r.preventDefault(e)) : (l = !0,
            n.value = s,
            n.select(),
            setTimeout(function() {
                l = !1,
        ...
        var B = function(e) {
          ...
          , F = function(e) {
            ...
            k = function(n) {
                ...
                n = n.replace(/\x01/g, ""),
                n == r.lastValue ? "" : (r.lastValue && i && t.undo(),
                n)
            }
            ,
            t.onCompositionEnd(),
    ...
    (function() {
        ...
        this.$onChange = function(e) {
            ...
            for (var a = 0, f = u.length; a < f; a++) {
                ...
                if (l.start.row > r)
                    break;
                l.start.row == r && l.start.column >= t.column && (l.start.column != t.column || !this.$insertRight) && (l.start.column += o,
                l.start.row += s);
...
ace.define("ace/edit_session", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/config", "ace/lib/event_emitter", "ace/selection", "ace/mode/text", "ace/range", "ace/document", "ace/background_tokenizer", "ace/search_highlight", "ace/edit_session/folding", "ace/edit_session/bracket_match"], function(e, t, n) {
    ...
    (function() {
        ...
        this.onChange = function(e) {
            ...
            t && t.length != 0 && this.$deltasFold.push({
                action: "removeFolds",
                folds: t
            }),
        ...
        this.$getUndoSelection = function(e, t, n) {
            ...
            var i = e[0], s, o, u = !1;
            r(i) ? (s = f.fromPoints(i.start, i.end),
            u = !0) : (s = f.fromPoints(i.start, i.start),
            u = !1);
            ...
            if (t.$isMultiLine)
                var o = n.length
                  , u = function(t, r, u) {
                    ...
                    c.start.column = Number.MAX_VALUE) : u && (c.start.column += u);
                    if (i(c))
                        return !0
                };
            else if (t.backwards)
...
ace.define("ace/editor", ["require", "exports", "module", "ace/lib/fixoldbrowsers", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/keyboard/textinput", "ace/mouse/mouse_handler", "ace/mouse/fold_handler", "ace/keyboard/keybinding", "ace/edit_session", "ace/search", "ace/range", "ace/lib/event_emitter", "ace/commands/command_manager", "ace/commands/default_commands", "ace/config", "ace/token_iterator"], function(e, t, n) {
    ...
    (function() {
        ...
        this.onCursorChange = function() {
            this.$cursorChange(),
            this.$blockScrolling || (g.warn("Automatically scrolling cursor into view after selection change", "this will be disabled in the next version", "set editor.$blockScrolling = Infinity to disable this message"),
            this.renderer.scrollCursorIntoView()),
        ...
        this.insert = function(e, t) {
            ...
            if (this.getBehavioursEnabled() && !t) {
                ...
                s && (e !== s.text && (this.session.mergeUndoDeltas = !1,
        ...
        this.jumpToMatching = function(e, t) {
            ...
            do {
                if (s.value.match(/[{}()\[\]]/g))
                    ...
                    s && s.type.indexOf("tag-name") !== -1 && (isNaN(a[s.value]) && (a[s.value] = 0),
    ...
    (function() {
        ...
        this.update = function(e) {
            ...
            for (; ; ) {
                ...
                if (y) {
                    p.foldWidget || (p.foldWidget = r.createElement("span"),
            ...
            w += E.left + E.right,
            w !== this.gutterWidth && !isNaN(w) && (this.gutterWidth = w,
...
ace.define("ace/layer/text", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/lib/event_emitter"], function(e, t, n) {
    ...
    (function() {
        ...
        this.renderIndentGuide = function(e, t, n) {
            ...
            return r <= 0 || r >= n ? t : t[0] == " " ? (r -= r % this.tabSize,
            e.push(s.stringRepeat(this.$tabStrings[" "], r / this.tabSize)),
            t.substr(r)) : t[0] == "	" ? (e.push(s.stringRepeat(this.$tabStrings["	"], r)),
            t.substr(r)) : t
        }
        ,
    ...
    (function() {
        ...
        this.update = function(e) {
            ...
            for (var n = 0, i = t.length; n < i; n++) {
                ...
                this.drawCursor ? this.drawCursor(o, s, e, t[n], this.session) : (o.left = s.left + "px",
                o.top = s.top + "px",
